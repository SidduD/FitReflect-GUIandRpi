...
# Start the stopwatch
def start(label):
    asyncio.run(send_socket_message("Squat"))
    global running
    running = True
    counter_label(label)
...
image_label.pack()
label = tk.Label(root, text="Squat", font=("Arial", 35, "bold"),fg='white', bg='black')
label.pack(pady=20)
...
# Start button
start_button = tk.Button(controls_frame, height=2, width=4, text='Start', state='normal', command=lambda: start(stopwatch_label),font=("Arial", 20),bg="Cadet Blue")
start_button.pack(side='left', padx=5)

# Stop button
stop_button = tk.Button(controls_frame, height=2, width=4, text='Stop', state='disabled', command=stop, font=("Arial", 25),bg="Cadet Blue")
stop_button.pack(side='left', padx=5)

# Reset button
reset_button = tk.Button(controls_frame, height=2, width=4,padx=10, pady=10, text='Reset', state='disabled', command=lambda: reset(stopwatch_label), font=("Arial", 30),bg="Cadet Blue")
